...
class _HScreenState extends State<HScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        backgroundColor: const Color(0xffe3efe3),
        appBar: AppBar(
          ...
          child: Container(
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                ListTile(
                  leading: const Icon(Icons.person,color: Colors.black,size: 33,),
                      ...
                      child:Container(
                        ...
                        child: const Row(
                          children: [
                            ...
                            SizedBox(width: 9,),
                            Text('उत्पाद का नाम टाइप करें',style: TextStyle(color: Colors.grey),)
                          ],
                        ),
                              ...
                              Stack(
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: RichText(
                                      text: TextSpan(
                                          text:  'नमस्ते, नैना!',style: GoogleFonts.poppins(color:Colors.black,fontSize: 24,fontWeight: FontWeight.w700),
                                          children: [
                                            TextSpan(
                                              text:'\nआज आप क्या जानना चाहते हैं?',style: GoogleFonts.poppins(color:Colors.grey.shade900,fontSize: 14,fontWeight: FontWeight.w400),
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      '\nबेहतर कल के लिए टिकाऊ रास्ता',style: GoogleFonts.poppins(color:Colors.green.shade900,fontSize: 14,fontWeight: FontWeight.w500),
                                                    ...
                                                    child: Stack(
                                                      children: [
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: RichText(
                                                            text: TextSpan(
                                                                text:  'जलवायु परिवर्तन दिन-ब-दिन बदतर होता जा रहा है',style: GoogleFonts.poppins(color:Colors.white,fontSize: 12,fontWeight: FontWeight.w400),
                                                                children: [
                                                                  TextSpan(
                                                                    text:'  आगे पढ़ें...',style: GoogleFonts.poppins(color:Colors.lightBlue,fontSize: 12,fontWeight: FontWeight.w400),
                      ...
                      child: Row(
                        children: [
                          ...
                          InkWell(
                            ...
                            child:const Icon(CupertinoIcons.book_fill,color: Colors.black,size: 30,),),
                          const SizedBox(width: 122,),
                          InkWell(
                              onTap: (){
                                Navigator.pushNamed(context, RoutesName.drawerPage);
                              },
                              child: const Icon(Icons.person,color: Colors.black,size: 33,)),
                          const SizedBox(width: 10,),
                          InkWell(
                            onTap: (){
